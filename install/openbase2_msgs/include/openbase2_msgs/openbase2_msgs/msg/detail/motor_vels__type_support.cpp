...
{
  new (message_memory) openbase2_msgs::msg::MotorVels(_init);
}

void MotorVels_fini_function(void * message_memory)
{
  auto typed_message = static_cast<openbase2_msgs::msg::MotorVels *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MotorVels_message_member_array[2] = {
  {
    ...
    offsetof(openbase2_msgs::msg::MotorVels, right_pwm),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(openbase2_msgs::msg::MotorVels, left_pwm),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MotorVels_message_members = {
  ...
  2,  // number of fields
  sizeof(openbase2_msgs::msg::MotorVels),
...
{
  return &::openbase2_msgs::msg::rosidl_typesupport_introspection_cpp::MotorVels_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, openbase2_msgs, msg, MotorVels)() {
  return &::openbase2_msgs::msg::rosidl_typesupport_introspection_cpp::MotorVels_message_type_support_handle;
}
