...
static const _EncoderData_type_support_symbol_names_t _EncoderData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, openbase2_msgs, msg, EncoderData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, openbase2_msgs, msg, EncoderData)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, openbase2_msgs, msg, EncoderData)() {
  return &::openbase2_msgs::msg::rosidl_typesupport_c::EncoderData_message_type_support_handle;
}
