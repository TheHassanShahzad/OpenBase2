...
static const _EncoderData_type_support_symbol_names_t _EncoderData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, openbase2_msgs, msg, EncoderData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, openbase2_msgs, msg, EncoderData)),
  }
};
...
{
  return &::openbase2_msgs::msg::rosidl_typesupport_cpp::EncoderData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, openbase2_msgs, msg, EncoderData)() {
  return get_message_type_support_handle<openbase2_msgs::msg::EncoderData>();
}
